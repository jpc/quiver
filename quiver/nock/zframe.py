...
from .. import ipc
# the nock footer-index layer now lives in nockidx (the only part qvm shares);
# re-exported here so zframe's own executor + existing callers keep working.
from .nockidx import (SKIP_MAGIC, _SKIP_CHUNK, _ZF_SCHEMA, _FOOTER_IPC,  # noqa: F401
                      _FNUM_DT, _FOOTER_PL, _footer_bytes, _write_footer, read_index)
...
Result = collections.namedtuple("Result", "members frames")   # schema/footer
